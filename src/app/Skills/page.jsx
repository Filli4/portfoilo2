    ...
    <div className=" grid grid-rows content-center gap-y-16">
      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <p className="text-gray-600 m-4 w-2/4">
          I have learned and used these languages to make my projects. I love some of the languages but some I find hard. Right now I&apos;m very interested in learning <b>React with Next.JS</b>.
        </p>
      </div>
