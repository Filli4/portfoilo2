  ...
  return (
    <div className='items-center flex-col flex-wrap'>
      ...
      <p className='text-gray-600 m-4 w-2/4'>
        I just want to show some of the projects I did here on the front page&rsquo; You can go to <b><i>projects</i></b> page on the navbar if you want to see more or just hit the <b><i>More Info</i></b> to take you there&rsquo;
      </p>
      <Cards />
