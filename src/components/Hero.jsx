function Hero(params) {
  ...
  <img src="https://th.bing.com/th/id/OIP.pq44iRkWZ2WP_2POcjCk-AHaHa?w=184&h=184&c=7&r=0&o=5&dpr=1.3&pid=1.7" alt="placeholder" className="w-full lg:w-96 justify-self-center rounded-2xl" />
</div>
